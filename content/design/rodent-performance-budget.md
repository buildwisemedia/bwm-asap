...
- Current artifact hashes: HTML `6630558c…f713f`, CSS `c20f5ff1…f91f`, JavaScript `e4901a3c…d750`.
- The limits are executable in `qa/asap-close-qa.mjs`; Lighthouse and field data are not claimed.
