...
State: evidence complete for local review; **not production-cleared**. Verified 2026-08-17.
...
- The six other image files used across the five pages are byte-identical to the pre-existing ASAP base commit `b86b3bf4b5d8e911f80e2d860ec5106917abf3cc`.
...
5. **Promotion hygiene.** Rodent uses `asap-close.css?v=4`; the four specific pages use `v=3`. The file is identical locally, but the version must align before promotion. That change would alter the exact reviewed page hashes and trigger renewed exact-artifact verification.
...
- After those decisions, align the CSS cache-buster, re-run exact QA/review, and only then ask Robert whether the protected preview may be exposed or sent to James.
